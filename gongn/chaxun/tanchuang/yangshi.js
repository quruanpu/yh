...
.chaxun-detail-image-item:hover {
    border-color: #dbeafe;
    background: #f3f8ff;
}

.chaxun-detail-image-item img {
    width: 56px;
    height: 56px;
    object-fit: cover;
    border-radius: 6px;
