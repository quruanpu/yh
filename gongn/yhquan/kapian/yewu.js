        ...
        return `
            <div class="yhquan-card" data-id="${coupon.id}">
                ...
                <div class="yhquan-card-row yhquan-card-tags">
                    ...
                    ${(YhquanGongju.getCouponStatus(coupon).valid && coupon.isSharing) ? `<span class="yhquan-tag yhquan-tag-ewm" data-id="${coupon.id}" title="生成二维码链接"><i class="fa-solid fa-qrcode"></i></span>` : ''}
                </div>
