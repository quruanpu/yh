...
.yhquan-cj-body > .yhquan-cj-section {
    flex-shrink: 0;
}
...
#yhquan-cj-form-area > .yhquan-cj-section {
    flex-shrink: 0;
}

#yhquan-cj-form-area > .yhquan-cj-section:last-child {
    flex: 1;
    min-height: 88px;
    display: flex;
    flex-direction: column;
...
#yhquan-cj-form-area > .yhquan-cj-section:last-child .yhquan-cj-form-group {
    flex: 1;
    min-height: 0;
    display: flex;
}

#yhquan-cj-form-area > .yhquan-cj-section:last-child .yhquan-cj-textarea {
    flex: 1;
    height: 100%;
    min-height: 48px;
}
