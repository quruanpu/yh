...
const ZsYewu = {
                ...
                <div class="yhquan-zs-content">
                    <div class="yhquan-zs-header">
                        <span class="yhquan-zs-title">
                            <i class="fa-solid fa-gift"></i> 赠送 - ${YhquanGongju.escapeHtml(coupon.name)}
                        </span>
            ...
            <div class="yhquan-zs-section">
                ...
                <div class="yhquan-zs-info-grid">
                    ...
                    <div class="yhquan-zs-info-row">
                        ...
                        <span class="yhquan-zs-info-value">${YhquanGongju.getCouponDetail(coupon)}</span>
                    </div>
                    <div class="yhquan-zs-info-row">
                        <span class="yhquan-zs-info-label">有效期：</span>
                        <span class="yhquan-zs-info-value">${YhquanGongju.getValidPeriod(coupon)}</span>
                    </div>
                    <div class="yhquan-zs-info-row">
    ...
    renderGiftSettings() {
        return `
            ...
            <div class="yhquan-zs-section">
                <div class="yhquan-zs-section-title">3.赠送方式</div>
                <select id="yhquan-zs-parse-mode" class="yhquan-zs-quantity-select">
                    <option value="auto" selected>自动解析</option>
                    <option value="storeId">药店ID</option>
                    <option value="storeCode">客户编码</option>
    ...
    renderTargetInput() {
        return `
            <div class="yhquan-zs-section">
                <div class="yhquan-zs-section-title">4.赠送目标</div>
    ...
    async handleSubmit() {
        ...
        const parseMode = document.getElementById('yhquan-zs-parse-mode')?.value || 'auto';
        ...
        try {
            const result = await this.callGiveAllAPI(inputText, quantity, parseMode);
            if (result.success) {
            ...
            if (error.message === 'COUPON_LIMIT') {
                ...
                this.showNotification(`赠送出错：${error.message || '未知错误。'}`, 'error');
            }
        }
    },

    async callGiveAllAPI(inputText, amount, parseMode = 'auto') {
    ...
    isValidCoupon(coupon) {
        return YhquanGongju.getCouponStatus(coupon).valid;
    }
};

window.ZsYewu = ZsYewu;
