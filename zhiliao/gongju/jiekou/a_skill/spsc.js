(function registerVideoCreateSkill() {
    ...
    window.ToolSkillDefinitions.push({
        ...
        promptGuidance:
            ...
            '- 纯文字生成视频不要传 image_ref/image_url/images/first_frame/last_frame。只有用户明确要求“让这张图动起来、基于刚上传/刚生成图片、图生视频、用参考图”时，才使用 image_url/image_urls/images/image_ref/image_refs/first_frame/last_frame；最近图片可用 image_ref: "last"。\n' +
